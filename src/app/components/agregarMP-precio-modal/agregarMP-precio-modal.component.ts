...
@Component({
  selector: 'app-agregarMP-precio-modal',
  templateUrl: './agregarMP-precio-modal.component.html',
  styleUrls: ['./agregarMP-precio-modal.component.css']
})
export class AgregarMPModalPrecioComponent implements OnInit, AfterViewInit {
  listado: any;
  listadoOriginal: any;
  ...
  constructor(public dialogRef: MatDialogRef<AgregarMPModalPrecioComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any, private dialog: MatDialog,private mpServ: MateriaPrimaService,
