...
@Component({
  selector: 'app-modificar-valor-modal',
  templateUrl: './modificar-valor-modal.component.html',
  styleUrls: ['./modificar-valor-modal.component.css']
})
export class ModificarValorModalComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    private dialogRef: MatDialogRef<ModificarValorModalComponent>,
